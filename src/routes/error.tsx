  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-6">
        <ErrorContent errorCode={code} title={errorDetails.title} description={errorDetails.description} />

        <p className="text-center text-xs text-muted-foreground/60">{t("error.contactSupport")}</p>
      </div>
    </div>
  )
}
